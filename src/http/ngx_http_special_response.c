...
"<hr><center><i class='fa fa-hand-o-right' style='font-size:36px'></i>&nbsp;&nbsp;<a href='https://github.com/JuneFoxy'>Github@JuneFoxy/QwQ/5.2.0</a></center>" CRLF
"<hr><center><p id='demo'></p></center>" CRLF
"<script> var myVar=setInterval(function(){myTimer()},1000); function myTimer(){ var d=new Date(); var t=d.toLocaleTimeString(); document.getElementById('demo').innerHTML=t; } </script>" CRLF
"</body>" CRLF
"</html>" CRLF
;
...
static char ngx_http_error_301_page[] =
        "<html>" CRLF
"<head>" CRLF
"<title>( QwQ..)</title>" CRLF
"<meta name='viewport' content='width=device-width, initial-scale=1'>" CRLF
"<link rel='stylesheet' href='https://cdn.staticfile.org/font-awesome/4.7.0/css/font-awesome.css'>" CRLF
"</head>" CRLF
"<body>" CRLF
"<center><i class='fa fa-transgender-alt' style='font-size:36px'></i>Nothing happened, sir...</center>" CRLF
;
