...
static u_char ngx_http_server_string[] = "Server: Github@JuneFoxy/QwQ/5.2.0" CRLF;
static u_char ngx_http_server_full_string[] = "Server: Github@JuneFoxy/QwQ/5.2.0" CRLF;
static u_char ngx_http_server_build_string[] = "Server: Github@JuneFoxy/QwQ/5.2.0" CRLF;
